...
public class TitConSearchCommand implements Command {
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 전체 페이지 수 가져오기
		Paging p = new Paging();		
		p.setTotalRecord(boardDAO.getTotalSearchCount(search));
...
//		System.out.println("p.getTotalRecord() : " + p.getTotalRecord());
		...
		// 리스트 가져오기
		List<BoardVO> bbsList = boardDAO.getSearchList(p.getBegin(), p.getEnd(), search);
