	                        ...
	                        <table class="table table-hover" style="text-align: center;">
	                        	...
	                        	<tr>
				                    ...
				                    <th width="20%">등록일</th>
	                       			...
	                       			<c:forEach var="ucvo" items="${uriCommentList }">
                        				<tbody>
				                        	<tr>
							                    <th width="20%">${ucvo.uriBoardIdx }</th>
				                        		<th width="15%">${ucvo.uriCommentIdx }</th>
							                    <th width="15%">${ucvo.id }</th>
							                    <th width="30%">
							                    <a href="${pageContext.request.contextPath}/dongnae/controller?type=detail&uriBoardIdx=${ucvo.uriBoardIdx }" class="text-blue">
							                    	${ucvo.content }
							                    </a>
							                    </th>
							                    <th width="20%">${ucvo.regdate }</th>
				                        	</tr>
			                        	</tbody>
		                        	</c:forEach>
                        		</table>                                        
