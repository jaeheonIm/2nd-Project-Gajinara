	                       	...
	                       	<table class="table table-hover" style="text-align: center;">
	                        	...
	                        	<tr>
				                    ...
				                    <th width="12%">가격</th>
	                       			...
	                       			<c:forEach var="bvo" items="${soldOutList }">
                        				<tbody>
				                        	<tr>
				                        		<th width="5%">${bvo.boardIdx }</th>
							                    <th width="15%"><a href="${pageContext.request.contextPath}/boardcontrol?type=viewcon&boardIdx=${bvo.boardIdx}" class="text-blue"><img src="${pageContext.request.contextPath}/upload/${bvo.img }" height="110px"></a></th>
							                    <th width="10%">${bvo.buyerId }</th>
