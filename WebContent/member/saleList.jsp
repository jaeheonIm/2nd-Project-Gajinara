                    	...
                    	<h5>판매중인 상품</h5> 
	                        ...
	                        <table class="table table-hover" style="text-align: center;">
	                        	...
	                        	<tr>
                       			...
                       			<c:forEach var="bvo" items="${saleList }">
		                        	<tr>
		                        		<th width="15%">${bvo.boardIdx }</th>
					                    <th width="10%"><a href="${pageContext.request.contextPath}/boardcontrol?type=viewcon&boardIdx=${bvo.boardIdx}" class="text-blue"><img src="${pageContext.request.contextPath}/upload/${bvo.img }" height="110px"></a></th>
					                    <th width="15%">${bvo.id }</th>
