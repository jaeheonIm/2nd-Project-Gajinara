...
<!-- Css Styles -->
    ...
    <link href="${pageContext.request.contextPath}/css/MemberCSS/findId.css" rel="stylesheet" type="text/css">
<!-- Google Font -->
...
<div id ="container">
	...
	<form action="${pageContext.request.contextPath}/member/controller?type=findId" method="post" method="post" id="findidform">
		<div class="wrap">
			<div class="join-wrap">
				<div id="join_btn">
					...
					<div class="btn_findId">
						<input type="button" id="findid_submit" value="아이디 찾기">
					</div>
					<div class="btn_link">
						<ul class="findId_btn">
							<li>
								<a href="${pageContext.request.contextPath}/member/findPwd.jsp" class="findId_text">비밀 번호 찾기</a>
							</li>
							<li class="bar">
								|
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/boardcontrol?type=start" class="findId_text">메인 페이지</a>
							</li>
						</ul>
					</div>
				</div>
